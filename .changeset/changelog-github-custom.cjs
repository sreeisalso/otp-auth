...
var changelogFunctions = {
    getDependencyReleaseLine: function (changesets, dependenciesUpdated, options) { return __awaiter(void 0, void 0, void 0, function () {
        var changesetLink, _a, updatedDependenciesList;
        return __generator(this, function (_b) {
            switch (_b.label) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, get_github_info_1.getInfo)({
                                                repo: options.repo,
                                                commit: cs.commit,
                                            })];
                                    case 1:
                ...
                case 1:
                    changesetLink = _a.apply("- Updated dependencies [", [(_b.sent())
                            .filter(function (_) { return _; })
                            .join(", "), "]:"]);
                    updatedDependenciesList = dependenciesUpdated.map(function (dependency) { return "  - ".concat(dependency.name, "@").concat(dependency.newVersion); });
                    return [2 /*return*/, __spreadArray([changesetLink], updatedDependenciesList, true).join("\n")];
            }
        });
    }); },
    getReleaseLine: function (changeset, type, options) { return __awaiter(void 0, void 0, void 0, function () {
        var prFromSummary, commitFromSummary, usersFromSummary, replacedChangelog, linkingIssueHints, _a, firstLine, futureLines, links, users, suffix, emojiFirstLine;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    replacedChangelog = changeset.summary
                        ...
                        .trim();
                    linkingIssueHints = function (line) {
                    ...
                    _a = replacedChangelog
                        .split("\n")
                        .map(function (l) { return linkingIssueHints(l.trimEnd()); }), firstLine = _a[0], futureLines = _a.slice(1);
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, get_github_info_1.getInfoFromPullRequest)({
                                                repo: options.repo,
                                                pull: prFromSummary,
                                            })];
                                    case 1:
                                        ...
                                        if (commitFromSummary) {
                                            ...
                                            links_1 = __assign(__assign({}, links_1), { commit: "[`".concat(shortCommitId, "`](https://github.com/").concat(options.repo, "/commit/").concat(commitFromSummary, ")") });
                                        }
                ...
                case 1:
                    ...
                    users = usersFromSummary.length
                        ? usersFromSummary
                            ...
                            return "[@".concat(userFromSummary, "](https://github.com/").concat(userFromSummary, ")");
                        })
                            .join(", ")
                        : links.user;
                    suffix = "";
