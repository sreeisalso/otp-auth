...
var changelogFunctions = {
	getDependencyReleaseLine: function (
		changesets,
		dependenciesUpdated,
		options
	) {
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					...
					case 1:
						...
						updatedDependenciesList = dependenciesUpdated.map(
							function (dependency) {
								return "  - "
									.concat(dependency.name, "@")
									.concat(dependency.newVersion);
							}
						);
						return [
							2 /*return*/,
				...
				switch (_b.label) {
					case 0:
						...
						((_a = replacedChangelog.split("\n").map(function (l) {
							return linkingIssueHints(l.trimEnd());
						})),
							(firstLine = _a[0]),
								...
								return __awaiter(void 0, void 0, void 0, function () {
									...
									return __generator(this, function (_a) {
										switch (_a.label) {
											...
											case 2:
												commitToFetchFrom =
													commitFromSummary || changeset.commit;
